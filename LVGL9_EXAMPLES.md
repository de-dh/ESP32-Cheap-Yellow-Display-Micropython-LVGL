...
| /lvgl9_examples/lvgl_screenshot  | Contains a program to take screenshots of the CYD's current screen and an image converter used to convert the *.raw screenshots to *.png images.|
...
RGB565 stores one pixel in 16 bits:
...
The converter expands these values to standard 8-bit RGB channels before saving the PNG file.
